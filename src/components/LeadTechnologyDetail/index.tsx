  ...
  return (
    <div className={styles.leadTechnologyDetail} ref={leadTechnologyDetail}>
      {CloudNativeDetailCard({
        ...
        img: '/images/cloudNativeDetail.png',
        arr: [
